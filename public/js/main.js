...
(function() {
	...
	// Scroll points.
		(function() {
            ...
            //Commented out because we got rid of href attribute
							// if (t.tagName == 'A'
	...
	// Icons: icons03.
		$('#icons03 > li:nth-child(1) > a').addEventListener(
			'click',
			function(event) { 
	...
	// "On Visible" animations.
		onvisible.add('.icons.style2', { style: 'fade-up', speed: 1000, intensity: 5, delay: 250, replay: false });
		onvisible.add('#image02', { style: 'zoom-out', speed: 1000, intensity: 5, delay: 250, replay: false });
		onvisible.add('#container02 > .wrapper > .inner', { style: 'fade-right', speed: 1000, intensity: 5, delay: 0, replay: false });
		onvisible.add('.container.style1 > .wrapper > .inner', { style: 'fade-left', speed: 1000, intensity: 5, delay: 0, replay: false });
		onvisible.add('#image04', { style: 'zoom-out', speed: 1000, intensity: 5, delay: 250, replay: false });
		onvisible.add('#image05', { style: 'zoom-out', speed: 1000, intensity: 5, delay: 250, replay: false });
		onvisible.add('.icons.style1', { style: 'fade-up', speed: 1000, intensity: 5, delay: 250, stagger: 250, replay: false });
		onvisible.add('#image06', { style: 'zoom-out', speed: 1000, intensity: 5, delay: 250, replay: false });
		onvisible.add('#image07', { style: 'zoom-out', speed: 1000, intensity: 5, delay: 250, replay: false });
		onvisible.add('#image01', { style: 'zoom-out', speed: 1000, intensity: 5, delay: 250, replay: false });
		onvisible.add('#image03', { style: 'zoom-out', speed: 1000, intensity: 5, delay: 250, replay: false });
